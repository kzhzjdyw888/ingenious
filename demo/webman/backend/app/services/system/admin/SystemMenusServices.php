...
class SystemMenusServices extends BaseServices
{
    ...
    {
        $this->dao = Container::make(SystemMenusDao::class);
    }
...
//            }
     ...
     */
    public function getMenusList(array|string $menuId, int $level = 1)
    {
    ...
    public function getMenus($roleId): array
    {
        ...
        if (!$roleId) {
            ...
            $service = Container::make(SystemRoleMenuServices::class);
