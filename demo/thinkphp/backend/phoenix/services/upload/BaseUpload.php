...
abstract class BaseUpload extends BaseStorage
{
     ...
     * @var array|object
     */
    protected array|object $fileInfo;
     ...
     * @return false|string
     */
    protected function getUploadPath(string $key): bool|string
    {
    ...
    public function getUploadInfo(): array
    {
        if (isset($this->fileInfo->filePath)) {
            ...
            return [
                ...
                'size'             => !empty($headers['size']) ? $headers['size'] : $this->fileInfo->uploadInfo->getSize(),
                'type'             => !empty($headers['type']) ? $headers['type'] : $this->fileInfo->uploadInfo->getType(),
                'dir'              => $this->fileInfo->filePath,
                'ext'              => $this->fileInfo->uploadInfo->getExtension(),
     ...
     * @return mixed
     */
    abstract public function move(string $file = 'file'): mixed;
     ...
     * @return mixed
     */
    abstract public function stream($fileContent, string $key = null): mixed;
     ...
     * @return mixed
     */
    abstract public function delete(string $filePath): mixed;
