...
// +----------------------------------------------------------------------
namespace phoenix\services\upload\storage;

use phoenix\services\upload\BaseUpload;
use phoenix\exceptions\AdminException;
use phoenix\exceptions\UploadException;
use GuzzleHttp\Psr7\Utils;
use Qcloud\Cos\Client;
use QCloud\COSSTS\Sts;
use phoenix\services\upload\extend\cos\Client as CrmebClient;
...
class Cos extends BaseUpload
{
     ...
     * @var mixed
     */
    protected mixed $uploadUrl;

    /**
     * 存储空间名称  公开空间
     * @var mixed
     */
    protected mixed $storageName;

    /**
     * COS使用  所属地域
     * @var mixed|null
     */
    protected mixed $storageRegion;
     ...
     */
    protected function upload(string $file = null, bool $isStream = false, string $fileContent = null): bool|array|\StdClass
    {
        if (!$isStream) {
     ...
     * @return mixed
     */
    public function stream($fileContent, string $key = null):mixed
    {
        if (!$key) {
     ...
     * @return mixed
     */
    public function move(string $file = 'file', bool $realName = false):mixed
    {
     ...
     * @return array
     */
    public function thumb(string $filePath = '', string $fileName = '', string $type = 'all'):array
    {
