 ...
 * MIT License By http://116.62.237.101:8009/
 ...
 +------------------------------------------------------------------------------------+
 */
layui.define(["layer", 'flow', "laytpl", "element", "form", "slider", "laydate", "rate", "colorpicker", "carousel", "upload", "formField", "staticField", "numberInput", "iconPicker", "cron", "labelGeneration"]
    , function (exports) {
        var $ = layui.jquery
            , layer = layui.layer
            , laytpl = layui.laytpl
