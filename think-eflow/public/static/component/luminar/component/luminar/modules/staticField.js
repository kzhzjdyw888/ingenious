layui.define(['layer'], function (exports) {
    ...
    let staticField = {
        ...
        templateFormList: [
            {
                text: '默认模板', imageUrl: "./component/luminar/images/11.PNG",
                value: [
                    {
                        "id": "input_1",
                        "index": 0,
        ...
        iceEditMenus: [
            ...
            {value: 'removeFormat', text: '格式化样式'}, {value: 'code', text: '源码'}, {
                value: 'line',
                text: '菜单分割线'
            }
        ],
        formDesignerHtml: '<div class="layui-layout layui-layout-admin">\n' +
            ...
            '            </li>\n' +
            '            <li class="layui-nav-item">\n' +
            '                <a id="empty" href="#" class="empty">清空</a>\n' +
            '            </li>\n' +
            '            <li class="layui-nav-item">\n' +
            ...
            '        </div>\n' +
            '    </div>\n' +
            '    <div class="layui-body" style="padding-bottom: 10px;">\n' +
            '        <!-- 内容主体区域 -->\n' +
