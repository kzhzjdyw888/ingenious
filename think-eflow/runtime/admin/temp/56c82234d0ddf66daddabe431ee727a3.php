<?php /*a:1:{s:62:"C:\DATA\MyMotion\think-eflow\view\admin\admin\admin\index.html";i:1740615820;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script type="text/html" id="options">
    ...
    <button class="pear-btn pear-btn-warming pear-btn-sm" lay-event="role"><i class="layui-icon layui-icon-user"></i>
    </button>
    <button class="pear-btn pear-btn-warming pear-btn-sm" lay-event="permission">
...
<script>
    layui.use(['table', 'form', 'jquery', 'common'], function () {
        ...
        let MODULE_PATH = "<?php echo htmlentities((string) app('request')->root()); ?>/admin.admin/";
