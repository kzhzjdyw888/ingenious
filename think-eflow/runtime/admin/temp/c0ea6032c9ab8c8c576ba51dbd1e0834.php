<?php /*a:1:{s:67:"C:\DATA\MyMotion\think-eflow\view\admin\admin\permission\index.html";i:1740615820;}*/ ?>
	...
	<body class="pear-container">
        ...
        <script>
            layui.use(['table','form','treetable', 'jquery'],function () {
                ...
                let MODULE_PATH = "<?php echo htmlentities((string) app('request')->root()); ?>/admin.permission/";
