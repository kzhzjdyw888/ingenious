<?php /*a:1:{s:64:"C:\DATA\MyMotion\think-eflow\view\admin\wf\surrogate\insert.html";i:1740706077;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="mainBox">
        <div class="main-container mr-5">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="checkbox" name="enabled" lay-skin="switch" lay-filter="enabled" value="1" checked>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    const INSERT_API = "/admin/wf.surrogate/insert";
