<?php /*a:1:{s:70:"C:\DATA\MyMotion\main\module\thinkphp-eflow\view\admin\index\home.html";i:1741744529;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="layui-row layui-col-space12">
            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    <table class="layui-table">
                        ...
                        <tr>
                            <td>版本号</td>
                            <td><?php echo htmlentities((string) $ver); ?></td>
                        </tr>
                        <tr>
                            <td>操作系统</td>
                            <td><?php echo htmlentities((string) $os); ?></td>
                        </tr>
                        <tr>
                            <td>剩余空间</td>
                            <td><?php echo htmlentities((string) $space); ?></td>
                        </tr>
                        <tr>
                            <td>服务器地址</td>
                            <td><?php echo htmlentities((string) $addr); ?></td>
                        </tr>
                        <tr>
                            <td>运行环境</td>
                            <td><?php echo htmlentities((string) $run); ?></td>
                        </tr>
                        <tr>
                            <td>PHP版本</td>
                            <td><?php echo htmlentities((string) $php); ?></td>
                        </tr>
                        <tr>
                            <td>PHP运行方式</td>
                            <td><?php echo htmlentities((string) $php_run); ?></td>
                        </tr>
                        <tr>
                            <td>MYSQL版本</td>
                            <td><?php echo htmlentities((string) $mysql); ?></td>
                        </tr>
                        <tr>
                            <td>THINKPHP版本</td>
                            <td><?php echo htmlentities((string) $think); ?></td>
                        </tr>
                        <tr>
                            <td>上传附件限制</td>
                            <td><?php echo htmlentities((string) $upload); ?></td>
                        </tr>
                        <tr>
                            <td>执行时间限制</td>
                            <td><?php echo htmlentities((string) $max); ?></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
        ...
        <div class="layui-col-md3">
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    <a target="_blank" href="https://www.madong.tech" class="pear-btn pear-btn-success layui-btn-fluid" style="height: 50px;line-height: 50px;">官 网</a>
                    <br/>
                    <a target="_blank" href="http://flow-docs.madong.tech/" class="pear-btn pear-btn-primary  layui-btn-fluid" style="margin-top: 8px;height: 50px;line-height: 50px;">文 档</a>
                    <br/>
                    <a target="_blank" href="https://gitee.com/ingenstream/ingenious" class="pear-btn pear-btn-warming  layui-btn-fluid" style="margin-top: 8px;height: 50px;line-height: 50px;">下 载</a>
                </div>
            </div>
        </div>
    </div>
