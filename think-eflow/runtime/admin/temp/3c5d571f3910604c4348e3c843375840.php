<?php /*a:1:{s:71:"C:\DATA\MyMotion\main\module\thinkphp-eflow\view\admin\login\index.html";i:1741745691;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
...
<!--				<img class="logo" src="/static/admin/images/logo.png" />-->
				<div class="title">Think-Eflow</div>
				<div class="desc">
			...
			<?php if(config('web.login_captcha')==1): ?>
			<div class="layui-form-item">
		...
		<script>
			layui.use(['form', 'layer', 'jquery', 'element'], function () {
						...
						success: function (res) {
							...
							if (res.code==200){
								layer.msg(res.msg,{icon:1,time:1000},function () {
									location.href = '<?php echo (htmlentities((string) app('request')->root())) ? htmlentities((string) app('request')->root()) : "/"; ?>';
								})
							} else {
				...
				initCode();
				function initCode() {
					$('#codeimg').attr("src","<?php echo htmlentities((string) app('request')->root()); ?>/login/verify?data=" + new Date().getTime());
				}
