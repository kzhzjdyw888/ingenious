...
class XML
{
     ...
     *
     * @return array|\phoenix\services\upload\extend\cos\SimpleXMLElement
     */
    public static function parse(string $xml): array|SimpleXMLElement
    {
     ...
     * @return array
     */
    protected static function normalize($obj): array|SimpleXMLElement
    {
        $result = null;
