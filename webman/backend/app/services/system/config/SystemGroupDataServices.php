...
class SystemGroupDataServices extends BaseServices
{
    ...
    {
        $this->dao = Container::make(SystemGroupDataDao::class);
    }
     ...
     */
    public function getConfigNameValue(string $configName, int $limit = 0): array
    {
        /** @var SystemGroupServices $systemGroupServices */
        $systemGroupServices = Container::make(SystemGroupServices::class);
